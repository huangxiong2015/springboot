...
public class CustomDateTimeDeserializer extends JsonDeserializer<Date> {
	...
	String[] parterns = new String[] { "yyyy-MM-dd HH:mm:ss", "yyyy/MM/dd HH:mm:ss", "yyyy-MM-dd", "yyyy/MM/dd",
	...
	public Date deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
		...
		try {
			...
			logger.error("CustomDateTimeDeserializer deserialize is error:", e);
