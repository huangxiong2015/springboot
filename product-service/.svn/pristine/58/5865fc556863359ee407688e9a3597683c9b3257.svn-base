...
@Transactional
@Rollback
public class MovRulesManagerTest {
	...
	public void updateStatusTest() throws Exception{
		...
		MovRuleTemplate ruleTemplateEnable = movRulesManager.updateStatus(ruleId, ProductPriceRule.RuleStatus.ENABLED, userId, movRuleTemplate);
		
		MovRuleTemplate ruleTemplateDisable = movRulesManager.updateStatus(ruleId, ProductPriceRule.RuleStatus.DISABLED, userId, movRuleTemplate);
	}
	...
	public void getByIdTest() throws Exception{
		...
		MovRuleTemplate movRuleTemplate = movRulesManager.getById(id);
		
		String idNew = "832064737826074586";
		MovRuleTemplate movRuleTemplateNew = movRulesManager.getById(idNew);
	}
	...
	public void findListTes() throws Exception{
		String startDate ="2017-03-16 08:00:00";
		String endDate="2017-03-18 08:00:00";
		String ruleStatus="DISABLED";
		String vendorId="digikey";
		String brandId="haha";
		String ruleName="testrulename";
		String pricePurposeType="PRODUCT_PRICE";
		int page=1; 
		int size = 20;
		PageInfo<MovRuleTemplate> pageInfo = movRulesManager.findList(startDate, endDate, ruleStatus, vendorId, brandId, ruleName, pricePurposeType, page, size);
	}
}
