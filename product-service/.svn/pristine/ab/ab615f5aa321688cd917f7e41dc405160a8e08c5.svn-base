...
public class AuditConfiguration {
	...
	public void setAuditTrailManagers() {
		...
		// auditTrailManagers.add(new ConsoleAuditTrailManager());
	...
	YkyAuditTrailManagementAspect ykyAuditTrailManagementAspect() {
		return new YkyAuditTrailManagementAspect("PRODUCT", auditablePrincipalResolver(), this.auditTrailManagers,
