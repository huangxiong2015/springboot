...
public class PromotionAndModuleDraftVo{
	...
	private List<PromotionModuleDraftVo> list;
	...
	public List<PromotionModuleDraftVo> getList() {
		return list;
	}

	public void setList(List<PromotionModuleDraftVo> list) {
		this.list = list;
	}
