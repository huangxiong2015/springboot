...
@Transactional
@Rollback
public class MovRulesResourceTest extends ProductApplicationTestBase{
	...
	public void addTest() throws Exception{
		...
		restTemplate.postForEntity(host+"/v1/rules/mov", movRuleTemplate, null);
	}
	...
	public void deleteTest() throws Exception{
		...
		restTemplate.delete(host+"/v1/rules/mov/"+ruleId, MovRuleTemplate.class);	
	}
	...
	public void updateTest() throws Exception{
		...
		restTemplate.put(host+"/v1/rules/mov", movRuleTemplate);
	}
	...
	public void findByIdTest() throws Exception{
		this.mockPartyService();
		String ruleId = "809305860672061440";
		restTemplate.exchange(host+"/v1/rules/mov/"+ruleId, HttpMethod.GET, null, new ParameterizedTypeReference<MovRuleTemplate>(){});
	}
	...
	public void findListTest() throws Exception{
		...
		int pageSize = 20;
		this.mockPartyService();
		restTemplate.exchange(host+"/v1/rules/mov?page="+page+"&pageSize="+pageSize, HttpMethod.GET, null, new ParameterizedTypeReference<PageInfo<MovRuleTemplate>>(){});	
	}
	...
	public void updateStatusTest() throws Exception{
		...
		restTemplate.put(host+"/v1/rules/mov/"+ruleId+"/status?ruleId="+ruleId+"&status="+ProductPriceRule.RuleStatus.ENABLED, MovRuleTemplate.class);
