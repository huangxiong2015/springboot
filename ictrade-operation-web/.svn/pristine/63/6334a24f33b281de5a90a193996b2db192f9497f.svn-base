/**
 * Created classifiedAdsList.js by zr.xieyuanpeng@yikuyi.com on 2017年10月26日.
 */
var vm = '';
$(function() {
	vm = new Vue(
        ...
        data: { 
            ...
            initData: {
	    		...
	    		page: [{pageId: '7001', pageName: '首页'}, {pageId: '7002', pageName: '登录页'},{pageId: '7003', pageName: '商品详情页'},{pageId: '7004', pageName: '类目导航页'}],	//广告页面
	    		position: []
	    	},
            gridColumns: [          //表格列                
                {
                ...
                }},
                {
                	...
                	items:[
					 ...
					 },
                     {
                        ...
                        href : ykyUrl._this+'/advertisement/classifiedAds/edit.htm?recommendationId={recommendationId}',
                        //target : '_blank'
					...
					},
					{
                        ...
                        href : ykyUrl._this+'/advertisement/classifiedAds/detail.htm?recommendationId={recommendationId}',
                        target : '_blank'
        	...
        	onSearch : function(){ 
        		  ...
        		  +"?extend1="+ this.queryParams.extend1
        		  +($('#extend2').val()?("&extend2="+ encodeURIComponent($('#extend2').val())):'') 
