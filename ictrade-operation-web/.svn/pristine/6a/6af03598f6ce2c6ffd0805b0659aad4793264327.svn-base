	            ...
	            <div class="chart box-body " style="position: relative;">
                    ...
                    <div class="form-group wrap-info">
                    	<div class="col-md-11">
                            ...
                            <div class="col-sm-8" ><span v-html="companyInfo.corCategory=='2006'?companytype[companyInfo.corCategory]+'('+companyInfo.CORPORATION_CATEGORY_ID_OTHER+')':companytype[companyInfo.corCategory]"></span></div>                            
                        </div>
                        <div class="col-md-11">
