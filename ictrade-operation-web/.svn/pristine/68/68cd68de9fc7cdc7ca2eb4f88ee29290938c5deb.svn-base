...
<div class="wrapper"> 
  ...
  <div class="content-wrapper" id="manufacturer-edit">
	<section class="content-header">
	  <h1>
	 制造商 
	  		<small v-if="brandId==''">添加</small> 
		    <small v-else>编辑</small> 
	  </h1>
	  <ol class="breadcrumb">
	    <li><a href="${ctx}/manageManufacturer.htm"><i class="fa fa-dashboard"></i>Home</a></li>
	    <li class="active"><a  :href="newsHome">制造商</a></li>
	  </ol>
	</section> 
        ...
        <section class="col-lg-12">
          <div class="box box-danger ">
              <!-- Morris chart - Sales -->
                ...
                <div class="box-body "> 
                <input type="hidden" name="categoryTypeId" value="VENDOR">
				 <div class="form-group">
                    <div class="col-md-11">
                        <label for="specurl" class="col-sm-2 control-label">选择制造商<span class="text-red">*</span>：</label>
                        <div class="col-sm-7" > 
                        	...
                        	<div v-show="initData.newsId != ''">
		                       	<div class="manu_logo">
	                            	 ...
	                            	 <a href="javascript:void(0);" class="re-change"  @click="showVendorModel" v-if="!brandId">重新选择</a>  
	                            </div> 
                ...
                <div class="form-group" v-if="initData.newsId != ''">
                    <div class="col-md-11">
                        <label for="title" class="col-sm-2 control-label">制造商名称<span class="text-red">*</span>：</label>
                        <div class="col-sm-5"> 
                ...
                <div class="form-group" v-if="content.labelContent != 'nothing'">
	                <div class="col-md-11">
                        ...
                        <div class="col-sm-5"> 
                            <input type="text" class="form-control" name="content[activityUrl]" id="titleUrl" v-model.trim="content.activityUrl" maxlength="50" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group ">
                    <div class="col-md-11">
                        <label for="title" class="col-sm-2 control-label">制造商详情<span class="text-red">*</span>：</label>
                        <div class="col-sm-8">
                 ...
                 <div class="form-group ">
                    <div class="col-md-11">
                        <label for="title" class="col-sm-2 control-label">代理分销商：</label>
                        <div class="col-sm-5">
                        	<a class="s-a-btn" href="javascript:;" @click="showAgent = true;showModal = true;modalTitle = '请选择分销商';">选择分销商</a>
                        	<span>（最多选择20项）</span>
                ...
                >
                	...
                	<div v-if="showVendor" class="vendor-list">
                		<letter-select							
						    	 ...
						    	 :showSearch="brandSelect.showSearch"
    							 :show-letter="brandSelect.showLetter"
...
<script type="text/javascript" src="${ctx}/js/app/manageManufacturerEdit.js"></script>
