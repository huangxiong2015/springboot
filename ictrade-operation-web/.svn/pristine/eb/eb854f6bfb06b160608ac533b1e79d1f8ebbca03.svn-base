			...
			<div class="row mt20">
				<div class="col-xs-6">
					<div class="row ">
						...
						<div class="row mt30" v-if="datas.auditStatus == 0">
							<div class="col-xs-2 tr">
								<label></label>
							</div>
							<div class="col-xs-10 c5e">
								
				               <input id="passBtn" type="button" class="btn btn-light" @click="checkPass" value="通过审核">
	                           <input id="noPassBtn" type="button" class="btn btn-light" @click="opendescr" value="不通过审核">
					...
					syncData( //通过审核 
			        		ykyUrl.product + "/v1/products/standaudit/audit",
			        			...
			        			function(res,err) {
			        			 ...
			        			 $("#noPassBtn").addClass("disabled");
			        			  if(err == null){
			        				     layer.closeAll();
					        			 layer.msg('操作成功', {time: 3000});
					        			 setTimeout(function(){
					        				 location.href = ykyUrl._this + '/approveMaterial.htm'
					        			 },3000)
			        			    }
