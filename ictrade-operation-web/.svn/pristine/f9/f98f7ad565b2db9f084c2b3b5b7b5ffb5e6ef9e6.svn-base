          ...
          <div class="box box-danger goods-maintain">
              <!-- Morris chart - Sales -->
                ...
                <div class="box-body ">
                	...
                	<div><button id="multipleDelete" class="btn btn-success sendData margin10" @click="multipleDelete('productList')"> 批量删除</button></div>
                </div>
			...
			<div id="uploadProduct" class="chart box-body" style="display:none;" v-if="getTableData">
			   <rowspan-table
			          :columns="gridColumns"
			          :pageflag="pageflag"
			          :query-params="queryParamsAll"
			          :checkflag = "checkflag"
			          :api="url"
			          :refresh="refresh"  
			  >
			  ...
			  <div class="activity-downlad">
			  	<button id="multipleDelete" class="btn btn-success sendData margin10" @click="multipleDelete('uploadList')"> 批量删除</button>
			  	<button id="export1" class="btn btn-success sendData margin10" @click="downloadSelect"><i class="fa fa-download mr5"></i> 导出</button>
			  	<button id="export2" class="btn btn-success sendData margin10" @click="downloadError"><i class="fa fa-download mr5"></i> 导出异常商品</button>
		  		</div>
			</div>											
