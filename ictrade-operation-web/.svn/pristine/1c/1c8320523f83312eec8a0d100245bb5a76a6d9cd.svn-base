...
var vm = new Vue({
	...
	data: {
		loseDescribe: '',
		//url: 'http://localhost:27082'+'/v1/vendorManage/getVendorManageList?type='+type,
		url: ykyUrl.party+'/v1/vendorManage/getVendorManageList?type='+type,
		queryParams : { //请求接口参数 
			size : 10, //分页参数
			page : 1, //当前页
