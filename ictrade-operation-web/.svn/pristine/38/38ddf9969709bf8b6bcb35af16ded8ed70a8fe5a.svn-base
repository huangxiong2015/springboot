	   							...
	   							<div class="col-sm-12 col-md-11 col-lg-11 bor-rig-light">
			                        ...
			                        <!-- <div class="col-md-4 margin10">
				   						<div class="form-group-sm">
					   						...
					   						<div class="col-sm-7">
					   							<input type="text" name="contactUserName" id="contactUserName" placeholder="申请人" class="form-control" v-model="queryParams.contactUserName"/>
					   						</div>
				   						</div>
				   					</div>	 -->			                        
...
<script src="${ctx}/js/app/vendorCheckList.js"></script>
