...
<c:import url ="/WEB-INF/jsp/include/lemon/layout.jsp"/>
  <div class="content-wrapper" id="activity-list">
		<section class="content-header"><h1>活动管理</h1></section> 
   <section class="content">
   <div class="row">
	   	<div class="col-md-12">
	   		<div class="box">
	   			<div class="box-body customCol">
	   			<form class="form-horizontal" id=""  @submit.prevent="onSearch">
	   				<div class="row">
	   				<div class="col-sm-12 col-md-11 col-lg-11 bor-rig-light">
		   					...
		   					<div class="col-md-2 ">
		   						<div class="form-group-sm">
			   						<label for="title" class="col-sm-4 control-label">活动类型</label> 
			   						<div class="col-sm-7">
			   							<select id="type" name="type" class="input-sm form-control" v-model="queryParams.type">
        ...
        <section class="col-sm-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              <a href="${ctx}/activity/information.htm" class="btn btn-sm btn-danger pull-right">
...
<script type="text/javascript" src="${ctx}/js/app/activityList.js"></script>
</body>
</html>