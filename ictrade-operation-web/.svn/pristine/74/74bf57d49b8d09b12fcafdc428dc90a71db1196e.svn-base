                ...
                }},
                {
                	...
                	items:[
					 ...
					 },
                     {
                        ...
                        text: '编辑',
                        show : "'{prStatus}' =='STOP' ",
                        href : 'timepromotion/information/{activityId}.htm',   //编辑页
                        //target : '_blank'
					...
					},
					{
                        ...
                        href : 'timepromotion/detail.htm?activityId={activityId}',
                        target : '_blank'
                    ...
                    },
                    {
                        ...
                        text: '查看',
                        show : "'{prStatus}'=='GOING'",
                        href : ykyUrl.portal+'/topic/miaosha.htm', //跳转到活动页
                        target : '_blank'
