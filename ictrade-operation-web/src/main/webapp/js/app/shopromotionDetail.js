...
vm = new Vue({
        ...
        beforeCreate:function(){
        	...
        	//查询活动详情
        	syncData(
        			ykyUrl.product + "/v1/activities/"+activityId+"/standard",    //查询活动列表信息
					"GET",
					null,
					function(res, err) {
        			    if(res){
					    	 ...
					    	 vm.datas.iconScenes = vm.datas.iconScenes?JSON.parse(vm.datas.iconScenes):'';
					    	 vm.datas.specifySupplier = res.specifySupplier ? 'true' : 'false';
					    	 vm.datas.supplierRule = vm.datas.supplierRule?JSON.parse(vm.datas.supplierRule):[];
					    	 }
		...
		var standard=function(){
			//查询商品信息
			syncData(
				ykyUrl.product + "/v1/activities/"+activityId+"/products/standard?page=1&activityType=10000",   //查询活动商品信息     li
