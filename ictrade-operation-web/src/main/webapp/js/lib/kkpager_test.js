...
var kkpager = {
		...
		generPageHtml : function(config,enforceInit){
			...
			var str = '';
			var dot = '<span class="spanDot">...' + this.total + '</span>';
			var dot2 = '<span class="spanDot">...</span>';
			...
			if(this.isWrapedPageBtns){
				pagerHtml += '<span class="pageBtnWrap">' + str_first + str  + '</span>' + '<span class="infoTextAndGoPageBtnWrap">' + total_info + gopage_info + '</span>' + '<span class="pageBtnWrap">' + str_prv + str_next + str_last + '</span>'
			}else{
				pagerHtml += str_first + str + str_prv +  str_next + str_last;
			}
