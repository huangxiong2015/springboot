          ...
          <div class="box box-danger goods-maintain">
              <!-- Morris chart - Sales -->
                ...
                <div class="box-body ">
	  				...
	  				<table class="prd-list">	  					
	  					<tbody>
	  						...
	  						<tr  :class="[item.status=='UNABLE'?'text-red': '']">	  							
	  							...
	  							<td>
	  								<a href="javascript:;" v-on:click="editProduct(item.activityProductId)" v-if="item.status=='ENABLE'">编辑</a>
                	...
                	<div>
	                	<button id="multipleDelete" class="btn btn-success sendData margin10" @click="multipleDelete('productList')"> 批量删除</button>
...
<script type="text/javascript" src="${ctx}/js/app/timePromotionMaintain.js"></script>
</body>
</html>