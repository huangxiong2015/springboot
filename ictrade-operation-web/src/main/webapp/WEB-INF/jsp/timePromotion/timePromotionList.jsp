...
<c:import url ="/WEB-INF/jsp/include/lemon/layout.jsp"/>
  <div class="content-wrapper" id="activity-list">
		<section class="content-header"><h1>限时促销</h1></section> 
        ...
        <section class="col-sm-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              <a href="${ctx}/timepromotion/information.htm" class="btn btn-sm btn-danger pull-right">
...
<script type="text/javascript" src="${ctx}/js/app/timePromotionList.js"></script>
</body>
</html>