...
<c:import url ="/WEB-INF/jsp/include/lemon/layout.jsp"/>
  <div class="content-wrapper" id="advertisement-list">
		...
		<div class="content-header tab-header" >
  			<a href="${ctx}/advertisement.htm" class="header-tab-item">站内广告</a>
  			<a href="javascript:void(0);" class="active header-tab-item">类别广告</a>
 		</div> 
	        ...
	        <section class="col-sm-12">
	          <div class="box ">
	            ...
	            <div class="box-header with-border">
	              <a href="${ctx}/advertisement/classifiedAds/edit.htm" class="btn btn-sm btn-danger pull-right"><i class="fa fa-plus"></i> 新增</a>
	            </div>
...
<script type="text/javascript" src="${ctx}/js/app/classifiedAdsList.js"></script>
</body>
</html>