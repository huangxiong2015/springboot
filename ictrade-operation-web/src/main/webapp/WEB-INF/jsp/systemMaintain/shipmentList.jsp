...
<c:import url ="/WEB-INF/jsp/include/lemon/layout.jsp"/>
  <div class="content-wrapper" id="shipment-list">
        ...
        <section class="col-sm-12">
          <div class="box ">
            ...
            <div class="box-header with-border">
              <a href="shipmentlist/create.htm" class="btn btn-sm btn-danger pull-right"><i class="fa fa-plus"></i> 新增</a>
            </div>
...
<script src="${ctx}/js/app/shipmentList.js"></script>
