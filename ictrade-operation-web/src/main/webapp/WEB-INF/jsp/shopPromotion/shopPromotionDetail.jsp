...
<title>商品促销-活动详情</title>
<style type="text/css">
.pd7{padding-top:7px;}
.promotion {border-top: 1px solid #eee;}
</style>
</head>
...
<body class="hold-transition skin-blue sidebar-mini">
	              ...
	              <section class="col-lg-12">
	                <div class="box box-danger activity-detail">
	                      ...
	                      <div class="box-header with-border">
	                        <h3 class="box-title"><span class="edit_state">活动详情-商品促销</span></h3>
	                      </div>
	                      <div class="box-body ">
	                              ...
	                              <div class="form-group " v-if="datas.specifySupplier == 'false'">
	                                  <div class="col-md-11">
	                              ...
	                              <div class="form-group " v-if="datas.specifySupplier == 'true'">
	                                  <div class="col-md-11">
	                                      <label class="col-sm-2 control-label" >活动分销商：</label>
	                                      <div class="col-sm-4  pd7" >
	                                      	<span v-for="item in datas.supplierRule" v-html="item.supplierName"></span>
	                                      </div>
	                                  </div>
	                              </div>
	                              <div class="form-group">
	               ...
	               <!--start content -->
	                      <!-- <div  style="height:700px;" > -->
	                          ...
	                          <div class="form-group "  style="padding-left: 15%;" v-if="datas.specifySupplier == 'false'">
	...
	<!---footer  end   ---->
	<script type="text/javascript" src="${ctx}/js/app/shopromotionDetail.js"></script>
</body>
</html>