...
<c:import url ="/WEB-INF/jsp/include/lemon/layout.jsp"/>
  <div class="content-wrapper" id="distributor-detail">
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
	    <li><a href="${ctx}/manageManufacturer.htm"><i class="fa fa-dashboard"></i> 首页</a></li>
		...
		<div class="row">
          <section class="col-lg-12">
	            <div class="box box-danger ">
	                <!-- Morris chart - Sales -->
	                  <div class="box-header with-border">
	                    <h3 class="box-title">制造信息</h3>
	                  </div>
	                  <div class="box-body form-horizontal"> 
                              <div class="form-group ">
                                  <div class="col-md-11">
                                      <label class="col-sm-3 control-label">制造商LOGO：</label>
                                      <div class="col-sm-5"> 
                              ...
                              <div class="form-group ">
                                  <div class="col-md-11">
                                      <label class="col-sm-3 control-label">制造商简介：</label>
                              ...
                              <div class="form-group ">
                                  <div class="col-md-11">
                                      <label class="col-sm-3 control-label">代理分销商：</label>
            ...
            <div class="box-footer text-center"> 
                <button type="button" class="btn btn-default c-btn" onclick="history.go(-1);">返回</button>
            </div> 
		</div>
...
<script type="text/javascript" src="${ctx}/js/app/manageManufacturerDetail.js"></script> 
</body>
</html>