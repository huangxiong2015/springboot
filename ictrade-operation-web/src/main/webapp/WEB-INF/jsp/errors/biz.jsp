...
<!--主体-->
<div>
	<div class="wrong_main pt30 hd">
      <div class="wrong_ct auto ovh">
        <div class="wg_right ml30 mr30 pr30">
           <div class="text b "><img src="${ctx }/images/static/error.png" /></div>             
           <div class="wr_ts f24 mt20 tc">抱歉，发生了业务异常<a href="${ctx }/" class="ovh mr20 "><span class="f16 home tc dib" style="color:#3377aa">返回首页</span></a></div>
        </div>        
      </div>
    </div>
</div>
