...
public class AliyunOSSConfig {
	...
	public List<String> getDomainListUAT() {
		return Arrays.asList("image:img0-uat.ykystatic.com", "file-uat.ykystatic.com");
	}
	...
	public List<String> getDomainListProd() {
		return Arrays.asList("image:img0.ykystatic.com", "image:img1.ykystatic.com", "file.ykystatic.com");
	}
