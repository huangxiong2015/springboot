 ...
 * @version 1.0.0
 */
@ApiModel("PartyProductLineJS")
public class PartyProductLineJS  {
	...
	private CreatedDateT createdDate;
	
	@ApiModelProperty(value = "最后修改人")
	private String lastUpdateUser;
	
	@ApiModelProperty(value = "最后修改时间")
	private LastUpdateDateT lastUpdateDate;
	
	
	public CreatedDateT getCreatedDate() {
		return createdDate;
	}

	public void setCreatedDate(CreatedDateT createdDate) {
		this.createdDate = createdDate;
	}

	public LastUpdateDateT getLastUpdateDate() {
		return lastUpdateDate;
	}

	public void setLastUpdateDate(LastUpdateDateT lastUpdateDate) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PartyProductLineJS other = (PartyProductLineJS) obj;
		if (brandName == null) {
