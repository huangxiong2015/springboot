...
import com.yikuyi.party.BasedataApplication;
...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT ,classes = {BasedataApplication.class, ApplicationTestConfig.class})
@ActiveProfiles("dev")
public class BasedataApplicationTestBase {
