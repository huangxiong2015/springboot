...
//		parameterMap.put("resultsSettings.refinements.filters", "");//选填
	...
	public void testSelenium() {
        System.getProperties().setProperty("webdriver.chrome.driver", "C:/Users/injor.huang/chromedriver/chromedriver.exe");
        WebDriver webDriver = new ChromeDriver();
        webDriver.get("https://www.arrow.com/en/categories/active-filters?page=3");
