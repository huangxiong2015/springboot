...
public class ShortUrlGenerator {
   ...
   public static void main(String[] args) {  
      ...
      String sLongUrl = "http://4745159223.qzone.qq.com" ; //长链接  
//      String[] aResult = shortUrl (sLongUrl);  
//      // 打印出结果  
//      for ( int i = 0; i < aResult. length ; i++) {  
//          System. out .println( "[" + i + "]:::" + aResult[i]);// 任意一个都可以作为短链接码
//      }  
      
//      System.out.println(MD5Encode(sLongUrl));
      System.out.println(md5(sLongUrl));
