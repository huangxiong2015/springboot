...
import com.ictrade.tools.excel.Excel2007Reader;
 ...
 * @version 1.0.0
 */
public class LeadInProcesserXlsxSax implements LeadInProcesserSax, IRowReader {
	/**
	 * 转换的文件类型
	 */
	 ...
	 */
	public LeadInProcesserXlsxSax(IRowReader reader, File leadInFile) throws SystemException {
		this.leadInFile = leadInFile;
		this.reader = reader;
		try {
			Excel2007Reader excel07 = new Excel2007Reader();
			excel07.setRowReader(this);
			excel07.process(this.leadInFile.getAbsolutePath());
		} catch (IOException e) {
	...
	public void setMaxNum(int sheetIndex, int num) {
		reader.setMaxNum(sheetIndex, num);
	}
